...
class Encomienda(models.Model):
    ...
    def clean(self):
        ...
        if hasattr(self, 'remitente_id') and hasattr(self, 'destinatario_id'):
...
# ==========================================
    ...
    # ==========================================
    # MÉTODOS DE INSTANCIA (Lógica de un objeto)
    # ==========================================
    ...
    def calcular_costo(self):
        ...
        peso_float = float(self.peso_kg)
        
        if peso_float > PESO_BASE:
            costo += (peso_float - PESO_BASE) * PRECIO_POR_KG_EXTRA
    ...
    def crear_con_costo_calculado(cls, remitente, destinatario, ruta, empleado, descripcion, peso_kg, **kwargs):
        ...
        # Calculamos el costo temporalmente llamando al método
